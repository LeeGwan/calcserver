...
class Recv_To_RoutineServer : public UdpBase
{
public:
    void Init(const std::string In_Ip, int Recv_In_port_from_Routine, int In_workerCount);
...
private:
    ...
    SockAddrIn serverAddr_from_Routine_to_Calc = {};
